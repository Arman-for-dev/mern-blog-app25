        ...
        <div className='flex-1'>
          <form className=' flex flex-col gap-4'>
            ...
            <div>
              ...
              <TextInput type='text' placeholder='example@mail.com' id="email" />
            </div>
            <div>
              <Label htmlFor="email1">Your Password</Label>
              <TextInput type='text' placeholder='Password' id="password" />
            </div>
            <Button gradienDuoTone="purpleToPink" type='submit'>Sing Up</Button>
          </form>
